...
const sketch = (p5) => {
    const primaryHex = getComputedStyle(document.body).getPropertyValue('--primary').trimStart() // 2 characters of whitespace preceeding
    const primary = hexRgb(primaryHex, { format: 'array' }).slice(0, -1)
